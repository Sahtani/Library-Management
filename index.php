...
<head>
  ...
  <!-- google font -->
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <header class="py-4 px-4 sm:px-10 bg-white z-50 relative">
      <div class='max-w-7xl w-full mx-auto flex flex-wrap items-center gap-4'>
        ...
        <div class='flex ml-auto'>
          ...
          ">
          <button
            class='bg-blue-100 hover:bg-blue-200 flex items-center transition-all font-semibold rounded-md px-5 py-3'>Log In
      ...
      <div class="max-w-7xl w-full mx-auto py-16">
        <div class="grid lg:grid-cols-2 justify-center items-center gap-10">
          ...
          <div class="max-lg:mt-12 h-full">
            <img src="images/back.png" alt="banner img" class="w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </div>
